...
use crate::application::agent_runtime::{
    ...
    workspace_can_stop_agent, workspace_status_targets_for_polling,
...
struct GroveApp {
    ...
    next_workspace_status_poll_due_at: Option<Instant>,
    preview_poll_in_flight: bool,
    preview_poll_requested: bool,
    preview_poll_started_at: Option<Instant>,
    workspace_status_poll_in_flight: bool,
    workspace_status_poll_requested: bool,
    workspace_status_poll_started_at: Option<Instant>,
    workspace_status_poll_cursor: usize,
