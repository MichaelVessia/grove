...
impl GroveApp {
    ...
    pub(super) fn from_parts_with_clipboard_and_projects(
        ...
        let mut app = Self {
            ...
            next_workspace_status_poll_due_at: None,
            preview_poll_in_flight: false,
            preview_poll_requested: false,
            preview_poll_started_at: None,
            workspace_status_poll_in_flight: false,
            workspace_status_poll_requested: false,
            workspace_status_poll_started_at: None,
            workspace_status_poll_cursor: 0,
