...
- Phase 4 progress: `groved` Unix socket daemon skeleton now supports JSON `ping`, stale socket recovery, and `workspace list`/`workspace create`/`workspace edit` request handling.
